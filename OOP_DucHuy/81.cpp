...
main.cpp:13:13: note: previous declaration ‘Complex Complex::operator+(const Complex&)’
   13 |     Complex operator+(const Complex&);
      |             ^~~~~~~~
main.cpp:33:6: error: no declaration matches ‘void Complex::operator+(const Complex&)’
   33 | void Complex::operator+(const Complex& obj)
      |      ^~~~~~~
main.cpp:28:9: note: candidate is: ‘Complex Complex::operator+(const Complex&)’
   28 | Complex Complex::operator+(const Complex& obj)
      |         ^~~~~~~
